...
export const GENRE_THEMES: Record<string, GenreThemeConfig> = {
  ...
  Default: {
    ...
    bgGlowClass: "from-slate-900 via-slate-950 to-black",
    borderClass: "border-purple-500/40",
    buttonClass: "bg-purple-600 hover:bg-purple-500 text-white shadow-purple-950",
    petalColor: "none",
    panelBgClass: "bg-slate-900/80 backdrop-blur-xl border-gray-800",
    cardBgClass: "bg-slate-900/60 border-gray-800 hover:border-purple-500/50",
    cssVars: {
      "--theme-primary": "#A855F7",
      "--theme-primary-rgb": "168, 85, 247",
      "--theme-secondary": "#06B6D4",
      "--theme-accent": "#E9D5FF",
      "--theme-bg-start": "#0B0F17",
      "--theme-bg-end": "#04060A",
      "--theme-header-bg": "rgba(17, 24, 39, 0.85)",
      "--theme-header-border": "rgba(255, 255, 255, 0.08)",
      "--theme-panel-bg": "rgba(17, 24, 39, 0.75)",
      "--theme-panel-border": "rgba(255, 255, 255, 0.08)",
      "--theme-card-bg": "rgba(30, 41, 59, 0.5)",
      "--theme-card-border": "rgba(255, 255, 255, 0.06)",
      "--theme-card-hover-border": "rgba(168, 85, 247, 0.4)",
      "--theme-card-hover-glow": "rgba(168, 85, 247, 0.25)",
      "--theme-text-title": "#FFFFFF",
      "--theme-text-accent": "#C084FC",
      "--theme-text-muted": "#94A3B8",
    },
